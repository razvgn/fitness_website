...
const ProductList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.error) {
        toast.error("Adăugarea produsului a eșuat. Încearcă din nou.");
      } else {
        toast.success(`Produsul ${data.name} a fost adăugat.`);
  ...
  return (
    <section className="bg-neutral-500 min-h-screen flex justify-center items-center py-10">
      <div className="w-full max-w-4xl p-8 rounded-lg shadow-md">
        <AdminMenu />
        <h1 className="h1 text-white mb-8 mt-[4.5rem] text-center">
          Adăugare produs<span className="text-cyan-400">.</span>
        </h1>
        ...
        <div className="text-center mt-6">
          <button
            ...
            className="btn btn-primary text-xl h-[4rem] w-full px-4 py-2 rounded my-[0.5rem] transition duration-300"
          >
            Adaugă
          </button>
        </div>
